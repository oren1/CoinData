...
class CoinDataProducts {
    
    static let everyMonthSubscription = "coindata_one_month_sub"
    static let everyYearSubscription = "coindata_one_year_sub"

    private static let productIdentifiers: Set<ProductIdentifier> = [CoinDataProducts.everyMonthSubscription, CoinDataProducts.everyYearSubscription]
...
class IAPManager: NSObject {
    ...
    func updateIAPStatusForAppleReceit(json: [String: Any], userDefaults: UserDefaults) {
        ...
        guard let latestReceiptInfo = json["latest_receipt_info"] as? [[String: Any]] else {
            ...
            userDefaults.removeObject(forKey: CoinDataProducts.everyMonthSubscription)
            userDefaults.removeObject(forKey: CoinDataProducts.everyYearSubscription)
